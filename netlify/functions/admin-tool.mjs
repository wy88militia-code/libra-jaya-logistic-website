...
export default async request=>{
 ...
 let pendingQuotes=0,pendingMaster=false,waitingPickup=0,incidents=0,unreadNotifications=0,slaRed=0,slaYellow=0,pendingApprovals=0,billingOutstanding=0,accurateNeedsMapping=0;
