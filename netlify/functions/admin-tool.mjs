...
const cards=[
 ...
 ['Google Maps & Geocoding','Generate dan validasi koordinat 41 tujuan pilot: Sentani, Sentani Barat/Timur, Kota Jayapura dan Arso Kota.','/admin-maps-pilot','Buka Maps Pilot'],
