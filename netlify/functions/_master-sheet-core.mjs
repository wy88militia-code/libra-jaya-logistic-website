...
async function readMasterRanges(){
  ...
  const ranges=["'Master Lastmile'!A1:R1000","'Jarak Bandara-Kelurahan'!A1:AJ1000","'Zona Operasional Awal'!A1:K100","'Modal Rute Pilot'!A24:AH200"];
